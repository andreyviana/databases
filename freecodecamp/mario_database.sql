...
--
-- Name: sounds_soud_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.sounds_soud_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.sounds_soud_id_seq OWNER TO freecodecamp;

--
-- Name: sounds_soud_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.sounds_soud_id_seq OWNED BY public.sounds.sound_id;
...
ALTER TABLE ONLY public.sounds ALTER COLUMN sound_id SET DEFAULT nextval('public.sounds_soud_id_seq'::regclass);
...
INSERT INTO public.more_info VALUES (8, '1989-07-31', NULL, NULL, 6);
INSERT INTO public.more_info VALUES (9, '1990-04-13', 162, 59.1, 7);
...
--
-- Name: sounds_soud_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.sounds_soud_id_seq', 8, true);
...
--
-- Name: sounds key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.sounds
    ADD CONSTRAINT key FOREIGN KEY (character_id) REFERENCES public.characters(character_id);
